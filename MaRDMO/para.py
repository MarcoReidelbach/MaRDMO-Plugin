...
option = {'YesText': 'https://rdmorganiser.github.io/terms/options/yes_with_text_no/yes',
          ...
          'ContainedAsAssumptionIn': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind0',
          'ContainsAsAssumption': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind_0a',
          'ContainedAsBoundaryConditionIn': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind1',
          'ContainsAsBoundaryCondition': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind_1a',
          'ContainedAsConstraintConditionIn': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind2',
          'ContainsAsConstraintCondition': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind_2a',
          'ContainedAsCouplingConditionIn': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind3',
          'ContainsAsCouplingCondition': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind_3a',
          'ContainedAsFormulationIn': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind4',
          'ContainsAsFormulation': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind_4a',
          'ContainedAsInitialConditionIn': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind5',
          'ContainsAsInitialCondition': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind_5a',
          'ContainedAsFinalConditionIn': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind6',
          'ContainsAsFinalCondition': 'http://example.com/terms/options/MaRDI/MathematicalFormulation_kind_6a',
          ...
          'ContainsAsAssumption2': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind0',
          'ContainsAsBoundaryCondition2': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind1',
          'ContainsAsConstraintCondition2': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind2',
          'ContainsAsCouplingCondition2': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind3',
          'ContainsAsFormulation2': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind4',
          'ContainsAsInitialCondition2': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind5',
          'ContainsAsFinalCondition2': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind6',
          'ContainsAsInput': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind7',
          'ContainsAsOutput': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind8',
          'ContainsAsObjective': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind9',
          'ContainsAsParameter': 'http://example.com/terms/options/MaRDI/MathematicalTask_kind10',
          'ContainsAsInput2': 'http://example.com/terms/options/MaRDI/QuantityAndQuantityKind_kind0',
          'ContainsAsOutput2': 'http://example.com/terms/options/MaRDI/QuantityAndQuantityKind_kind1',
          'ContainsAsObjective2': 'http://example.com/terms/options/MaRDI/QuantityAndQuantityKind_kind2',
          'ContainsAsParameter2': 'http://example.com/terms/options/MaRDI/QuantityAndQuantityKind_kind3',
