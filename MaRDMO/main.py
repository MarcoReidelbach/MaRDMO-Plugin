...
class MaRDMOExportProvider(BaseMaRDMOExportProvider):
    ...
    def render(self):
        ...
        elif str(self.project.catalog).endswith('mardmo-algorithm-catalog'):
        ...
        elif str(self.project.catalog).endswith('mardmo-search-catalog'):
        ...
        elif str(self.project.catalog).endswith('mardmo-interdisciplinary-workflow-catalog'):
