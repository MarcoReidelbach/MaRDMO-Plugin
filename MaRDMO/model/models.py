...
class Task:
    ...
    def from_query(cls, raw_data: dict) -> 'Task':
        ...
        return cls(
            ...
            containsInitialCondition = [item for formulation in data.get('containsFormulation', {}).get('value', '').split(" / ") if formulation and (item := RelatantWithQualifier.from_query(formulation)).qualifier == 'mardi:Q6534264'] if 'containsFormulation' in data else [],
            containsFinalCondition = [item for formulation in data.get('containsFormulation', {}).get('value', '').split(" / ") if formulation and (item := RelatantWithQualifier.from_query(formulation)).qualifier == 'mardi:Q6534267'] if 'containsFormulation' in data else [],
            containsInput = [item for formulation in data.get('containsQuantity', {}).get('value', '').split(" / ") if formulation and (item := RelatantWithQualifier.from_query(formulation)).qualifier == 'mardi:Q6480299'] if 'containsFormulation' in data else [],
            containsOutput = [item for formulation in data.get('containsQuantity', {}).get('value', '').split(" / ") if formulation and (item := RelatantWithQualifier.from_query(formulation)).qualifier == 'mardi:Q6480295'] if 'containsFormulation' in data else [],
            containsObjective = [item for formulation in data.get('containsQuantity', {}).get('value', '').split(" / ") if formulation and (item := RelatantWithQualifier.from_query(formulation)).qualifier == 'mardi:Q6534255'] if 'containsFormulation' in data else [],
            containsParameter = [item for formulation in data.get('containsQuantity', {}).get('value', '').split(" / ") if formulation and (item := RelatantWithQualifier.from_query(formulation)).qualifier == 'mardi:Q6480341'] if 'containsFormulation' in data else [],
            containsConstant = [item for formulation in data.get('containsQuantity', {}).get('value', '').split(" / ") if formulation and (item := RelatantWithQualifier.from_query(formulation)).qualifier == 'mardi:Q6480317'] if 'containsFormulation' in data else [],
            specializes = [RelatantWithQualifier.from_query(model) for model in data.get('specializes', {}).get('value', '').split(" / ") if model] if 'specializes' in data else [],
            specializedBy = [RelatantWithQualifier.from_query(model) for model in data.get('specializedBy', {}).get('value', '').split(" / ") if model] if 'specializedBy' in data else [],
            approximates = [Relatant.from_query(model) for model in data.get('approximates', {}).get('value', '').split(" / ") if model] if 'approximates' in data else [],
            approximatedBy = [Relatant.from_query(model) for model in data.get('approximatedBy', {}).get('value', '').split(" / ") if model] if 'approximatedBy' in data else [],
